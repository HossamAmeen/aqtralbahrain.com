<?php
    ...
    */
    ...
    // Language
    Route::get('locale/{lang}',[LanguageController::class,'setLanguage']);
...
// User section start
    ...
    //Paymob
    Route::get('/paymob/payment', [PaymobController::class, 'initiatePayment'])->name('paymob.payment');

    Route::get('/paymob/success', [PaymobController::class, 'success'])->name('paymob.success');

    Route::get('/paymob/failure', [PaymobController::class, 'failure'])->name('paymob.failure');
