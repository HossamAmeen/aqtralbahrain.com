...
@section('main-content')
	...
	<!-- Shopping Cart -->
	<div class="shopping-cart section" @if(app()->getLocale()=="ar") style="direction:rtl !important;" @endif>
		<div class="container">
			<div class="row">
				<div class="col-12">
					<!-- Shopping Summery -->
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								...
								<th class="text-center">{{__('application.add_to_cart')}}</th> 
							...
							@else 
								<tr>
									<td class="text-center">
										{{__('application.there_is_no_wishlist_available')}} <a href="{{route('product-grids')}}" style="color:blue;">{{__('application.continue_shopping')}}</a>
