									...
									<div class="shop-top">
										<div class="shop-shorter">
											<div class="single-shorter">
												<label>{{__('application.show')}} :</label>
											...
											<div class="row">
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>{{__('application.add_to_wishlist')}}</span></a>
																</div>
																<div class="product-action-2">
																	<a title="Add to cart" href="{{route('add-to-cart',$product->slug)}}">{{__('application.add_to_cart')}}</a>
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<!-- <a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">{{__('application.buy_now')}}</a> -->
													</div>
												</div>
											</div>
										</div>
