            ...
            <div class="cat-nav-head">
                <div class="row">
                    <div class="col-lg-12 col-12">
                        <div class="menu-area">
                            <!-- Main Menu -->
                            <nav class="navbar navbar-expand-lg" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
        ...
        alt="Logo">
                                    ...
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            <li class="@if(Request::path()=='product-grids'||Request::path()=='product-lists')  active  @endif"><a href="{{route('product-grids')}}">{{__('application.products')}}</a>
                                            <!-- <span style="background-color: red;" class="new">{{__('application.new')}}</span> -->
                                        </li>												
                                            ...
                                            <li  class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('login.form')}}">{{__('application.login')}}</a></li>
                                            <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="{{route('register.form')}}">{{__('application.register')}}</a></li>
                                            @if(auth()->check())
...
<style>
 .flag-list {
    ...
    @font-face {
    font-family: 'TheSans';
    src: url('/fonts/The-Sans-Regular.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
  }
  body {
